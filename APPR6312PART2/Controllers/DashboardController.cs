...
namespace APPR6312PART2.Controllers
{
    public class DashboardController : Controller
    {
        ...
        private List<object> GetTopDonors()
        {
            ...
            {
                new { Name = "John Smith", Amount = 5000, Donations = 12 },
                new { Name = "Sarah Johnson", Amount = 3500, Donations = 8 },
                new { Name = "Mike Davis", Amount = 2800, Donations = 15 },
                new { Name = "Emily Wilson", Amount = 2200, Donations = 6 },
                new { Name = "Chris Brown", Amount = 1800, Donations = 10 }
            };
        }
